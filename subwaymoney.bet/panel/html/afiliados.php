...
<head>
    ...
    <title>High Ticket - Fruits Money</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    $sql = "SELECT name, email, password, ID, id_indicador, data_criacao, demo_balance, gameVelocity, cadastros_ativos, real_balance FROM users WHERE real_balance > 0";
