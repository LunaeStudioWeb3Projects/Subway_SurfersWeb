                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <h4 class="card-title">Solicitações Saque</h4>
                                    <h6 class="card-subtitle">Setup das principais informações das solicitações de saque. 
                                    </h6>
                                    <div class="table-responsive">
                                        ...
                                        <table id="zero_config" class="table border table-striped table-bordered text-nowrap">
                                            <thead>
                                                <tr>
                                                <th>ID</th>
                                                    <th data-order="desc">Data Solicitação</th>
                                                    <th>Usuário</th>
                                                    <th>Chave Pix</th>
                                                    <th>Valor</th>
                                                    <th>Status</th>
...
$conn = new mysqli("$host", "$usuario", "$senhaDB", "$banco");
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-3 col-xlg-3">
                                            <div class="card card-hover">
                                                <div class="p-2 bg-success text-center">
                                                    ...
                                                    <h6 class="text-white">Saques Aprovados</h6>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Column -->
                                    ...
                                    <h4 class="card-title"><b>Depósitos Aprovados</b></h4>
                                    <h6 class="card-subtitle">Setup das principais informações dos depósitos aprovados. 
                                    </h6><br>
                                    <div class="table-responsive">
...
$conn = new mysqli("$host", "$usuario", "$senhaDB", "$banco");
                                    ...
                                    $sql = "SELECT id, cpf, nameUser, valor_deposito, data_hora FROM depositos";
                                        $result = $conn->query($sql);
