                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-right user-dd animated flipInY">
                                <a class="dropdown-item" href="javascript:void(0)"><i data-feather="user"
                                    ...
                                    Perfil</a>
                                <a class="dropdown-item" href="pagamentos.php"><i data-feather="credit-card"
                                        class="svg-icon me-2 ms-1"></i>
                                    Pagamentos</a>
                                ...
                                <a class="dropdown-item" href="javascript:void(0)"><i data-feather="settings"
                                    ...
                                    Configurações</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="user-logout.php"><i data-feather="power"
                                        class="svg-icon me-2 ms-1"></i>
                                    Sair</a>
                                <div class="dropdown-divider"></div>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html">Veja como estão as suas métricas hoje:</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card ">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <h2 class="text-dark mb-1 font-weight-medium"><?php echo $total?></h2>
...
if ($result->num_rows > 0) {
    ...
    foreach ($usuarios as $usuario) {
        ...
        echo '<td class="font-weight-medium text-dark border-top-0 px-2 py-4">R$' . $usuario['RealBalance'] . '</td>';
        echo '</tr>';
    }
} else {
    echo "Nenhum resultado encontrado.";
