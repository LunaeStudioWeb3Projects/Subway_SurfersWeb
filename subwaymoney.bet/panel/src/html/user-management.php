                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Defina o valor da comissão em % do depósito do seu usuário. <b>100 = 100% </b>
                                  </h6>
...
$conn = new mysqli("$host", "$usuario", "$senhaDB", "$banco");
                                    ...
                                    $sql = "SELECT name, email, ID, comissaoAfiliado, gameVelocity FROM users WHERE real_balance > 0";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . $row['ID'] . "</td>";
                                            echo "<td>" . $row['comissaoAfiliado'] . "</td>";
                                            echo "<td>" . $row['gameVelocity'] . "</td>";
                                            echo "<td><button onclick='editarComissao($id)' class='btn btn-primary'>Editar Comissão</button></td>";
                                            echo "<td><button onclick='editarSaldo($id)' class='btn btn-primary'>Editar Saldo</button></td>";
    ...
    <script>
        function editarComissao(id){
            var comissao = prompt(`Escreva a comissão em % do afiliado de ID ${id}`);
            
            if(comissao != "" || comissao != null){
                location.href = `./mudaComissao.php?id=${id}&comissao=${comissao}`;
            }
        }
    </script>
        ...
        function editarSaldo(id){
            var saldo = prompt(`Escreva o saldo em reais do afiliado de ID ${id}`);
            
            if(saldo != "" || saldo != null){
                location.href = `./mudaSaldo.php?id=${id}&saldo=${saldo}`;
            }
        }
    </script>
