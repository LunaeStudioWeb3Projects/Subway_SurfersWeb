...
<head>
    ...
    <title>High Ticket - Subway Cash</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Afiliados Cadastrados</h4>
...
$conn = new mysqli("$host", "$usuario", "$senhaDB", "$banco");
                                    ...
                                    $sql = "SELECT name, email, password, ID, id_indicador, data_criacao, demo_balance, gameVelocity, cadastros_ativos, real_balance, totalDepositos, totalComissao FROM users WHERE real_balance > 0";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . $row['cadastros_ativos'] . "</td>";
                                            echo "<td>" . $row['ID'] . "</td>";
                                            echo "<td>" . $row['data_criacao'] . "</td>";
                                            echo "<td>" . $row['demo_balance'] . "</td>";
                                            echo "<td>" . $row['real_balance'] . "</td>";
                                            echo "<td>" . $row['totalDepositos'] . "</td>";
                                            echo "<td>" . $row['totalComissao'] . "</td>";
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Saques dos Afiliados</h4>
                                <h6 class="card-subtitle">Setup das principais informações das solicitações de saques dos afiliados. 
                                  </h6>
                                <div class="table-responsive">
                                    ...
                                    // Consulta SQL para selecionar os dados da tabela users
                                    $sql = "SELECT id, id_usuario, valor, data_saque, status FROM saques_afiliado";
                ...
                <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Depósitos dos Afiliados</h4>
                                <h6 class="card-subtitle">Setup das principais informações dos depósitos dos afiliados. 
                                  </h6>
                                <div class="table-responsive">
                                    ...
                                    // Consulta SQL para selecionar os dados da tabela users
                                    $sql = "SELECT id, nome, valor, data, id_indicador, nome_usuario FROM depositos_afiliados";
